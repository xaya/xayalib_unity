...
namespace MoverStateCalculator
{
	public class HelperFunctions
	{
		...
		public static bool ParseMove(ref JObject obj, ref Direction direction, ref Int32 steps)
		{
            ...
            //We should do this checks same as per C++
            //The best way is to get rid of dynamic type
            //and deserialize JSON into struct properly
            //then those checks will become available
