If you make any changes to the "BitcoinLib" and "XAYAWrapper" projects, you must recompile them and copy the new DLLs (and PDBs) into the proper folders under the XAYAUnity folder. i.e.:
